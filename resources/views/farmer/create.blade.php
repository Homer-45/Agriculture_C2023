...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-5">
            <div class="col-sm-6">
                <h1 class="m-2">Add Farmer Information</h1>
            </div>
        </div>
        <div class="row col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12 ml-5" style=" display: flex; align-items: center; justify-content: center;">
            ...
            <div class="card card-dark card-outline">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" action="{{ route('store.farmer') }}" method="POST" enctype="multipart/form-data" onsubmit="btn.disabled = true; return true;">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row form-group col-md-6">
                            ...
                            <input type="text" class="form-control text-center" name="reference_number" pattern="\d{4}-\d{4}-\d{4}-\d{4}" placeholder="XXXX-XXXX-XXXX-XXXX">
                        </div>
                        <div class="row">
