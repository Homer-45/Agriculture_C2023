...
<div class="content-header">
    <div class="container-fluid">
        ...
        <nav>
            <ol>
                <a href="{{ route('export.farmer') }}"><button class="btn btn-danger"> Download Xlsx</button></a>
            </ol>
        </nav>
        <div class="row col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12" style=" display: flex; align-items: center; justify-content: center;">
            ...
            <div class="card card-dark card-outline">
                ...
                <form class="forms-sample" action="{{ route('import') }}" method="POST" enctype="multipart/form-part" >
                    @csrf
